...
/*   Updated: 2023/11/28 22:19:31 by alappas          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	if (tmp->type == T_PIPE && tmp->next->type != T_WORD && tmp->next->type != T_RED_INP
		&& tmp->next->type != T_RED_OUT && tmp->next->type != T_APPEND && tmp->next->type != T_DELIM
